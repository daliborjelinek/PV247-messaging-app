...
export const AUTHENTICATION_CLEAN_ERROR_MSG = 'AUTHENTICATION_CLEAN_ERROR_MSG';
export type AUTHENTICATION_CLEAN_ERROR_MSG = typeof AUTHENTICATION_CLEAN_ERROR_MSG;
...
export type CHANNEL_DELETE_FAILED = typeof CHANNEL_DELETE_FAILED;
...
export const HIDE_MESSAGES_FOR_DELETED_CHANNEL = 'HIDE_MESSAGES_FOR_DELETED_CHANNEL';
export type HIDE_MESSAGES_FOR_DELETED_CHANNEL = typeof HIDE_MESSAGES_FOR_DELETED_CHANNEL;
export const ACTUALIZE_MESSAGES_IN_CHANNEL_STARTED = 'ACTUALIZE_MESSAGES_IN_CHANNEL_STARTED';
export type ACTUALIZE_MESSAGES_IN_CHANNEL_STARTED = typeof ACTUALIZE_MESSAGES_IN_CHANNEL_STARTED;
export const ACTUALIZE_MESSAGES_IN_CHANNEL_FINISHED = 'ACTUALIZE_MESSAGES_IN_CHANNEL_FINISHED';
export type ACTUALIZE_MESSAGES_IN_CHANNEL_FINISHED = typeof ACTUALIZE_MESSAGES_IN_CHANNEL_FINISHED;
...
export type MESSAGE_APP_MESSAGES_ACTIONS = MESSAGE_APP_LOADING_FINISHED | CURRENT_CHANNEL_CHANGE_FINISHED |
  ...
  HIDE_MESSAGES_FOR_DELETED_CHANNEL | ACTUALIZE_MESSAGES_IN_CHANNEL_STARTED | ACTUALIZE_MESSAGES_IN_CHANNEL_FINISHED;
...
export const USER_PROFILE_UPDATE_STARTED = 'USER_PROFILE_UPDATE_STARTED';
export type USER_PROFILE_UPDATE_STARTED = typeof  USER_PROFILE_UPDATE_STARTED;
export const USER_PROFILE_UPDATE_FINISHED = 'USER_PROFILE_UPDATE_FINISHED';
export type USER_PROFILE_UPDATE_FINISHED = typeof  USER_PROFILE_UPDATE_FINISHED;

// OTHERS
export const MESSAGE_APP_CLEAR_ALERTS = 'MESSAGE_APP_CLEAR_ALERTS';
export type MESSAGE_APP_CLEAR_ALERTS = typeof MESSAGE_APP_CLEAR_ALERTS;

// UPDATE MESSAGES TIMEOUT
export const INCREASE_MESSAGES_UPDATE_TIMEOUT = 'INCREASE_MESSAGES_UPDATE_TIMEOUT';
export type INCREASE_MESSAGES_UPDATE_TIMEOUT = typeof INCREASE_MESSAGES_UPDATE_TIMEOUT;
export const RESTORE_MESSAGES_UPDATE_TIMEOUT = 'RESTORE_MESSAGES_UPDATE_TIMEOUT';
export type RESTORE_MESSAGES_UPDATE_TIMEOUT = typeof RESTORE_MESSAGES_UPDATE_TIMEOUT;

export type UPDATE_MESSAGES_TIMOUT = INCREASE_MESSAGES_UPDATE_TIMEOUT |
  RESTORE_MESSAGES_UPDATE_TIMEOUT;

// FAILED ACTIONS (ACTION, WHICH ARE DISPLAYED IN ALERT COMPONENT) + CLEAR ALERT ACTION
export type ALERT_ACTIONS = CHANNEL_DELETE_FAILED | MESSAGE_APP_CLEAR_ALERTS;
